...
account_admin = Account.new(name: "One Million Voices Administrator", email:, password:, admin: "t")
account_admin.password_confirmation = password
account_admin.skip_confirmation!
account_admin.save!

account_agroecologia = Account.new(name: "One Million Voices", email: "contact@agroecologymap.org", password:, admin: "f")
